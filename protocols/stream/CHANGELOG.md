## 0.5.0-alpha (symbiosis-finance fork)
...
- Add `Control::accept_with_buffer` to queue inbound streams that arrive before the
  ...
  Dropped inbound streams are now logged at `warn`. Backport of
  [PR 6637](https://github.com/libp2p/rust-libp2p/pull/6637) without the version bump.
